...
read_count_hist_thesis <- read_count_hist +
...
ggsave(str_glue('{folder}read_count_hist_thesis.pdf'), read_count_hist_thesis, width = 2.93, height = 1.84)
```
...
gene_count_hist
ggsave(str_glue('{folder}gene_count_hist.pdf'), gene_count_hist, width = 86, height = 60, units = 'mm', dpi = 400)
```
...
mm_hist
ggsave(str_glue('{folder}mm_hist.pdf'), mm_hist, width = 86, height = 60, units = 'mm', dpi = 400)
```
...
toy_example_plot
ggsave(str_glue('{folder}toy_example_plot.pdf'), toy_example_plot, width = 120, height = 60, units = 'mm', dpi = 400)

toy_example_plot_no_legend <- toy_example_plot + theme(legend.position = 'none')
ggsave(str_glue('{folder}toy_example_plot_no_legend.pdf'), toy_example_plot_no_legend, width = 120, height = 60, units = 'mm', dpi = 400)

toy_example_plot_ML <- toy_example_plot + 
  theme_classic() +
  theme(axis.title = element_text(size = font_axis),
        axis.text = element_text(size = font_tick),
        legend.position = 'bottom',
  ...
  xlab('Genes ranked by expression') + 
  ylab('Relative expression') +
  scale_fill_manual(values = c('black',gg_color_hue(1), 'white')) +
  scale_x_discrete(labels = 1:30)

toy_example_plot_ML
ggsave(str_glue('{folder}toy_example_plot_ML.pdf'), toy_example_plot_ML, width = 120, height = 60, units = 'mm', dpi = 400)

toy_example_plot_ML_no_legend <- toy_example_plot_ML + theme(legend.position = 'none')
ggsave(str_glue('{folder}toy_example_plot_ML_no_legend.pdf'), toy_example_plot_ML_no_legend, width = 120, height = 60, units = 'mm', dpi = 400)
```
...
ggsave(str_glue('{folder}read_summary.pdf'), read_summary, width = 86, height = 60, units = 'mm', dpi = 400)
...
mm_cta_seq
ggsave(str_glue('{folder}mm_cta_seq.pdf'), mm_cta_seq, width = 86, height = 60, units = 'mm', dpi = 400)
```
...
feature_cta_seq
ggsave(str_glue('{folder}feature_cta_seq.pdf'), feature_cta_seq, width = 86, height = 60, units = 'mm', dpi = 400)
```
...
combined_dists_legend <- ggarrange(same_dist_legend, different_dist_legend, common.legend = T, legend = 'bottom')
...
combined_pbmc
ggsave(str_glue('{folder}pbmc_umap.png'), combined_pbmc, width = 120, height = 60, units = 'mm', dpi = 600)
```
...
nkg7_plot
ggsave(str_glue('{folder}nkg7_plot.pdf'), nkg7_plot, width = 60, height = 55.8, units = 'mm')
```

```{r pbmc_more_markers}
more_markers_plot <- readRDS(file = 'downstream_analysis_results/more_markers_plot.Rds')
more_markers_plot <- more_markers_plot +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5),
        legend.position = 'bottom',
        title = element_text(size = font_title),
...
more_markers_plot
ggsave(str_glue('{folder}more_markers_plot.pdf'), more_markers_plot, width = 178, height = 178, units = 'mm', dpi = 400)
```
...
spatial_clustering
ggsave(str_glue('{folder}spatial_clustering.png'), spatial_clustering, width = 178, height = 100, units = 'mm', dpi = 400)
```
...
brain_umap
ggsave(str_glue('{folder}brain_umap.png'), brain_umap, width = 86, height = 50, units = 'mm', dpi = 400)
```
...
brain_jaccard
ggsave(str_glue('{folder}brain_jaccard.pdf'), brain_jaccard, width = 86, height = 100, units = 'mm', dpi = 400)
```
...
spatial_marker
ggsave(str_glue('{folder}spatial_marker.png'), spatial_marker, width = 76.12, height = 52, units = 'mm', dpi = 400)
```
...
spatial_counts <- readRDS(file = 'spatial_transcriptomics/nReads_plot.Rds') +
  theme(legend.key.size = legend_key_size)
...
spatial_counts
ggsave(str_glue('{folder}spatial_counts.png'), spatial_counts, width = 86, height = 100, units = 'mm', dpi = 400)
```

```{r spatial_hists}
spatial_hist_plot <- readRDS(file = 'spatial_transcriptomics/spatial_hist_plot.Rds') +
  theme(legend.key.size = legend_key_size*0.75)

spatial_hist_plot <- spatial_hist_plot +
  theme_classic() +
  theme(legend.margin = margin(0,0,0,0),
        title = element_text(size = font_title),
        axis.title = element_text(size = font_axis),
        ...
        legend.box.spacing = unit(0.1, 'cm'),
        legend.position = 'bottom') +
  ggtitle('Distribution of log-norm. Expression Ttr') + 
  xlab('log norm. Expression') + 
  ylab('Density')
spatial_hist_plot
ggsave(str_glue('{folder}spatial_hist_plot.pdf'), spatial_hist_plot, width = 60, height = 45, units = 'mm')
ggsave(str_glue('{folder}spatial_hist_plot_no_legend.pdf'), spatial_hist_plot + theme(legend.position = 'none'), width = 61.55, height = 46.2, units = 'mm')
```
...
pancreas_combined
ggsave(str_glue('{folder}pancreas_umap.png'), pancreas_combined, width = 120, height = 57, units = 'mm', dpi = 400)
```
...
pancreas_flow
ggsave(str_glue('{folder}pancreas_flow.pdf'), pancreas_flow, width = 30, height = 55, units = 'mm')
```

```{r ari_plot}
ari_plot <- readRDS(file = 'clustering_experimentally_annotated_cells/ARI_plot.Rds')
ari_plot <- ari_plot +
   theme_classic() +
   theme(axis.title = element_text(size = font_axis),
         axis.text = element_text(size = font_tick),
...
ari_plot
ggsave(str_glue('{folder}ari_plot.pdf'), ari_plot, width = 178, height = 120, units = 'mm', dpi = 400)
```
