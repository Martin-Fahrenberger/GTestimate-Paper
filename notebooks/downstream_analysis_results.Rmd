...
NKG7_expression_tbl <- tibble(log_expression = GetAssayData(pbmc_seurat_ML, assay = 'RNA', layer = 'data')['NKG7',], method = 'NormalizeData')
NKG7_expression_tbl <- NKG7_expression_tbl %>% rbind(tibble(log_expression = GetAssayData(pbmc_seurat_GT, assay = 'GTestimate', layer = 'data')['NKG7',], method = 'GTestimate'))
NKG7_expression_tbl <- NKG7_expression_tbl %>% rbind(tibble(log_expression = GetAssayData(pbmc_seurat_SC, assay = 'SCT', layer = 'data')['NKG7',], method = 'SCTransform'))
```
